...
echo.
echo ==========================================
echo        movepattern XML Diff Tool
echo ==========================================
echo.
...
REM ---------- 检查脚本 ----------
if not exist movepattern_diff.py (
echo [ERROR] 未找到 movepattern_diff.py
...
echo 使用方法:
echo.
echo    movepattern_diff A.xml B.xml diff.xml
echo.
echo 或直接运行进入交互模式
echo.
...
python movepattern_diff.py "%AXML%" "%BXML%" -o "%OUTXML%"
